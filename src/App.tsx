...
function App() {
  const [state, dispatch] = useReducer(activityReducer, initialState); // dispatch retorna las acciones y state retorna el estado del reducer

  //este codigo se encarga de guardar el contenido en el localstorage
  useEffect(() => {
